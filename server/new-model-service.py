...
all_data_df = load_all_data('new_cases')
...
grouped_loc_df = grouped_loc_df.sort_values(by=['new_cases'], ascending=False)
resp = {}
for i in range(10):
	...
	data = filtered_df.new_cases.values
